...
function ItemDetail({ detalle }) {
  ...
  const rutaCategoria = `/category/${detalle.category}`;

  if (detalle.picture === undefined) {
    return <LoadingSpinner />;
  }

  document.title = `Lolita ${detalle.category}/${detalle.name}`;
